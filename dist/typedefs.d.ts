import { Matcher, MatcherOptions as MatcherOptions_, SelectorMatcherOptions as SelectorMatcherOptions_, waitForOptions } from '@testing-library/dom';
import { ElementHandle as PlaywrightElementHandle } from 'playwright';
export declare type ElementHandle = PlaywrightElementHandle<SVGElement | HTMLElement>;
declare type Element = ElementHandle;
declare type MatcherOptions = Omit<MatcherOptions_, 'normalizer'>;
declare type SelectorMatcherOptions = Omit<SelectorMatcherOptions_, 'normalizer'>;
...
interface IQueryMethods {
    ...
    findByPlaceholderText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByPlaceholderText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
    ...
    findByText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
    ...
    findByLabelText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByLabelText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
    ...
    findByAltText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByAltText(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
    ...
    findByTestId(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByTestId(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
    ...
    findByTitle(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByTitle(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
    ...
    findByRole(el: Element, m: Matcher, opts?: SelectorRoleMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByRole(el: Element, m: Matcher, opts?: SelectorRoleMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
    ...
    findByDisplayValue(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element>;
    findAllByDisplayValue(el: Element, m: Matcher, opts?: SelectorMatcherOptions, waitForOpts?: waitForOptions): Promise<Element[]>;
}
export declare type BoundFunction<T> = T extends (attribute: string, element: Element, text: infer P, options: infer Q) => infer R ? (text: P, options?: Q) => R : T extends (a1: any, text: infer P, options: infer Q, waitForOptions: infer W) => infer R ? (text: P, options?: Q, waitForOptions?: W) => R : T extends (a1: any, text: infer P, options: infer Q) => infer R ? (text: P, options?: Q) => R : never;
export declare type BoundFunctions<T> = {
    [P in keyof T]: BoundFunction<T[P]>;
};
